    ...
    >
      {isIcon ? (
        <button 
          ...
          className="w-full h-full bg-violet-600 text-white 
        ...
        <div className="h-full flex flex-col">
          <header className="flex-none px-2 h-[65px] border-b border-l flex items-center relative">
                <div className="flex items-center w-full">
                  ...
                  <h2 className="font-semibold absolute left-1/2 -translate-x-1/2 text-sm tracking-wide">GIGEco Assistant</h2>
